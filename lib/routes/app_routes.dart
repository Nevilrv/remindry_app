...
import 'package:untitled1/features/home/presentation/pages/expense/money_and_dent_no_data_view.dart';
...
class AppRoutes {
  ...
  static const String moneyAndDebt = "/moneyAndDebt";
  static const String moneyAndDebtNoData = "/moneyAndDebtNoData";
  ...
  static final router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: remindersSeeAll, name: remindersSeeAll, builder: (context, state) => const RemindersSeeAllPage()),
      ...
      GoRoute(path: moneyAndDebt, name: moneyAndDebt, builder: (context, state) => const MoneyAndDebtView()),
      GoRoute(path: moneyAndDebtNoData, name: moneyAndDebtNoData, builder: (context, state) => const MoneyAndDentNoDataView()),
      ...
      GoRoute(path: privacyPolicy, name: privacyPolicy, builder: (context, state) => const PrivacyPolicyScreen()),
      GoRoute(path: termsAndConditions, name: termsAndConditions, builder: (context, state) => const TermsAndConditionsScreen()),
      GoRoute(path: goPremium, name: goPremium, builder: (context, state) => const GoPremiumScreen()),
    ],
  );
}
