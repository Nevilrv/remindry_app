                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      5.hBox,
                      Container(
                        padding: EdgeInsets.only(left: 20.w, top: 5.h, bottom: 5.h, right: 4.w),
                        ...
                        child: Row(
                          children: [
                            ...
                            Container(height: 40, width: 2, margin: 5.px, color: AppColors.extraLightGray),
                            20.hBox,
                      ...
                      AppButton(
                        onTap: () {
                          if (provider.phoneController.text.trim().isEmpty || provider.selectedCountry.phoneCode.trim().isEmpty) {
