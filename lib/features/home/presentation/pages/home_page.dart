              ...
              Container(
                ...
                decoration: const BoxDecoration(
                  ...
                  gradient: const LinearGradient(
                    colors: [Color(0xffFF4059), Color(0xffB24FFF)],
        ...
        children: [
          ...
          Row(
            children: [
              ...
              12.wBox,
              Icon(Icons.air_outlined, size: 14.sp, color: AppColors.secondary),
              4.wBox,
              Text(
                "98% SpO₂",
                style: TextStyle(fontSize: 12.sp, color: AppColors.secondary),
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: const LinearGradient(
                              colors: [Color(0xffB24FFF), Color(0xffFF4059)],
